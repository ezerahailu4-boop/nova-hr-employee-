...
export const JOBS_CHANNEL_ID        = process.env.JOBS_CHANNEL_ID        || "@NovaHRsupply"

export default { BOT_TOKEN, ADMIN_CHAT_ID, COMPANY_NAME, WEBAPP_URL,
  NEXT_PUBLIC_SUPABASE_URL, NEXT_PUBLIC_SUPABASE_ANON_KEY, SUPABASE_SERVICE_KEY, ADMIN_TOKEN, JOBS_CHANNEL_ID }
